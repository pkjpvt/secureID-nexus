...
class Login:
    def __init__(self,root):
        ...
        self.bg=ImageTk.PhotoImage(file=r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\loginBg.jpg")
        ...
        img1=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\log1.png")
    ...
    def login(self):
        if (self.txtuser.get()=="" or self.txtpwd.get()==""):
            ...
            conn = mysql.connector.connect(username='root', password='Jantu@10478',host='localhost',database='face_recognition',port=3306)
...
# This part is image labels setting start
        ...
        # backgorund image
        bg1=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg.png")
        ...
        #title section
        title_lb1 = Label(bg_img,text="SecureID Nexus",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        title_lb1.place(x=0,y=0,width=1366,height=45)

        # Create buttons below the section
        # -------------------------------------------------------------------------------------------------------------------
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\std1.jpg")
        ...
        det_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\det1.jpg")
        ...
        att_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\att.jpg")
        ...
        hlp_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\hlp.jpg")
        hlp_img_btn=hlp_img_btn.resize((180,180),Image.LANCZOS)
        self.hlp_img1=ImageTk.PhotoImage(hlp_img_btn)

        hlp_b1 = Button(bg_img,image=self.hlp_img1,cursor="hand2",command=self.Help)
        hlp_b1.place(x=940,y=100,width=180,height=180)

        hlp_b1_1 = Button(bg_img,text="Help Support",cursor="hand2",command=self.Help,font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        # Start below buttons.........
         # Train   button 5
        tra_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\tra1.jpg")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\img.jpg")
        ...
        # Developers   button 7
        dev_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\dev.jpg")
        ...
        # exit   button 8
        exi_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\exi.jpg")
        exi_img_btn=exi_img_btn.resize((180,180),Image.LANCZOS)
        self.exi_img1=ImageTk.PhotoImage(exi_img_btn)

        exi_b1 = Button(bg_img,image=self.exi_img1,cursor="hand2",command=self.iExit)
...
# ==================Functions Buttons=====================
    ...
    def iExit(self):
        self.iExit=tkinter.messagebox.askyesno("SecureID Nexus","Do you want to exit?",parent=self.root)
        if self.iExit > 0:
            self.root.destroy()
        else:
            return
