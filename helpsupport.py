...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\web.png")
        ...
        det_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\fb.png")
        ...
        att_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\yt.png")
        ...
        hlp_img_btn=Image.open(r"C:\Users\Pankaj Sharma\Documents\Python_Test_Projects\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\gmail.png")
    ...
    def website(self):
        self.new = 1
        self.url = "https://www.dbuniversity.ac.in/"
        webbrowser.open(self.url,new=self.new)
    
    def facebook(self):
        self.new = 1
        self.url = "https://www.facebook.com/zing.zingsrm?mibextid=ZbWKwL"
        webbrowser.open(self.url,new=self.new)
    
    def youtube(self):
        self.new = 1
        self.url = "https://youtu.be/yE-X851-S4A?si=CFXhX1RYmUaNfG-B"
        webbrowser.open(self.url,new=self.new)
    
    def gmail(self):
        self.new = 1
        self.url = "https://mail.google.com/mail"
        webbrowser.open(self.url,new=self.new)
