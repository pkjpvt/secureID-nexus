...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","B.Tech","Computer Application","Commerce Management","Mass Communication")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course","CSE","BBA","BCA","MBA","MCA")
        cou_combo.current(0)
    ...
    def delete_data(self):
        if self.var_std_id.get() == "":
            ...
            try:
                ...
                if delete > 0:
                    conn = mysql.connector.connect(username='root', password='Jantu@10478', host='localhost',
